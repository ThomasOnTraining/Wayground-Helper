(function() {
    ...
    // --- (PARTE 3.1: POPULATE GUI - Sem alterações) ---
    function populateGUI(questions) {
        ...
        for (const qId in questions) {
            ...
            switch (questionKind) {
                ...
                case 'BLANK':
                    questionHTML = `<p class="qia-question-text">${questionText} (Tipo: ${questionKind})</p>`;
                    buttonHTML = `<button class="qia-ai-button" data-kind="${questionKind}" ${commonButtonData}>Resolver com IA 🤖</button>`;
                    break;
                default: continue;
            }
    ...
    // --- (PARTE 3.2: LÓGICA DA IA - Sem alterações) ---
