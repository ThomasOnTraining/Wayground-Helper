(function() {
    ...
    function buildPrompt(dataset) {
        ...
        switch (kind) {
            ...
            // MUDANÇA: Prompt para BLANK (Máximo 5 palavras)
            case 'BLANK':
            ...
            case 'OPEN':
                prompt = `Responda a seguinte pergunta de forma resumida, direta e com tom natural, como se fosse um colega. Crie uma resposta concisa, de apenas 1 a 3 frases, que cubra o ponto principal da questão. Responda APENAS com o texto da resposta.\n\nPergunta:\n"${decodeURIComponent(question)}"`;
                break;
        }
        return prompt;
    }
