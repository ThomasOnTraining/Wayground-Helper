...
// @version      13.1
// @description  [FUNCIONALIDADE COMPLETA] Auto-Preenchimento para questões DROPDOWN foi finalizado e agora funciona.
// @author       Você (com melhorias de Gemini)
// @match        *://quizizz.com/*
// @match        *://wayground.com/*
    ...
    function getSolutionFromAI(dataset, responseDiv, button) {
        ...
        switch (kind) {
            ...
            case 'DROPDOWN':
                ...
                prompt = `Analise a seguinte pergunta com lacunas para preencher (dropdowns). O texto da pergunta contém tags como <blank id=...></blank> que representam onde os dropdowns estão. Sua tarefa é determinar qual opção da lista de "Opções" se encaixa em cada lacuna. Responda com uma lista numerada, uma para cada lacuna na ordem em que aparecem. Formato: "1: [Opção Correta]", "2: [Opção Correta]", etc.\n\nPergunta:\n"${dropdownQuestion}"\n\nOpções Disponíveis:\n- ${dropdownOptionsAI.join('\n- ')}`;
                break;
            case 'REORDER':
