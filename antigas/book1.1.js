(function() {
    ...
    // <--- NOVO (Foco/Destaque): Seletor da Pergunta Ativa --->
    ...
    // --- PARTE 2: GUI (MERGE: Lógica v13.11 + Botões v13.13) ---
    ...
    window.addEventListener('GameDataIntercepted', function(event) {
        ...
        // Inicia o observer para detectar perguntas ativas
    ...
    function createGUI() {
        ...
        // <--- MERGE: HTML do Painel (v13.11 + v13.13) --->
        const panelHTML = `
            <div id="qia-header">
        ...
        // --- LÓGICA DE ARRASTAR E MINIMIZAR (v13.11) ---
        ...
        // --- FIM DA LÓGICA v13.11 ---

        // <--- NOVO: Listeners para Foco e Reset (v13.13) --->
    ...
    function populateGUI(questions) {
        ...
        for (const qId in questions) {
            ...
            // <--- NOVO (Foco/Destaque): Armazena o texto limpo no dataset --->
    ...
    // <--- NOVO: FUNÇÕES DE OBSERVER E FOCO (v13.13) --- (Sem alterações)
